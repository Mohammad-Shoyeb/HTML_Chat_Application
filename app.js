...
console.log({ from: socket.username, file: event.file.name, type: t, extension:ext });

		io.emit('uploaded', { from: socket.username, file: event.file.name, type: t, extension:ext });
	});
